...
export default function VolunteerHours() {
  ...
  const handlePrint = useReactToPrint({
    ...
    onAfterPrint: () =>
      Swal.fire("تم بنجاح", "تم استخراج سجل الساعات بصيغة PDF", "success"),
  });
    ...
    <div className="hours-container">
      ...
      <div className="hours-header-main">
        <div className="welcome-text">
          <h2>
            <FontAwesomeIcon icon={faAward} className="text-purple" /> سجل
            الساعات التطوعية
          </h2>
      ...
      <div className="hours-stats-grid">
        ...
        <div className="stat-card-modern secondary-white">
          <div className="stat-content">
            ...
            <h3>
              {new Set(hourLogs.map((l) => l.org)).size} <span>مؤسسات</span>
            </h3>
          </div>
      ...
      <div className="hours-content-layout">
        ...
        <div className="history-section-wrapper" ref={componentRef}>
          ...
          <div className="card-inner-header">
            <h3>
              <FontAwesomeIcon icon={faHistory} /> سجل الأنشطة التفصيلي
            </h3>
          </div>
          ...
          <div className="print-only-footer">
            <div className="print-summary-box">
              <p>
                نشهد بأن المتطوع المذكور أعلاه قد أتم{" "}
                <strong>{totalHours} ساعة عمل تطوعي</strong> معتمدة لدى المؤسسات
                المسجلة بالمنصة.
              </p>
            </div>
        ...
        <div className="distribution-sidebar">
              ...
              return (
                <div className="dist-card" key={index}>
                  <div className="dist-info">
                    ...
                    <span className="org-perc" style={{ color: log.color }}>
                      {percentage}%
                    </span>
                  </div>
          ...
          <div className="impact-box">
            ...
            <p>
              مجهودك يمثل <strong>{totalHours * 10} نقطة</strong> تأثير مجتمعي
            </p>
          </div>
        </div>
      </div>
