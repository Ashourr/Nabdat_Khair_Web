...
export default function CsaesService({ casesID }) {
            ...
            <div className="col-12">
              ...
              <div className="page-top">
                ...
                <div className="list-dropdown">
                  ...
                  {/* 🏢 فلتر المؤسسة */}
                  <div className="sorting-dropdown foundation-dropdown">
                    <button
                      style={{ width: "250px" }}
                      className="selected-option"
                      onClick={() => setIsFoundationOpen((p) => !p)}
                    >
                      <span className="dropdown-arrow">
                        <FontAwesomeIcon
                          icon={isFoundationOpen ? faChevronUp : faChevronDown}
                        />
                      </span>
                      {selectedFoundation}
                    </button>
                    ...
                    {isFoundationOpen && (
                      <ul className="options-list" style={{ width: "250px" }}>
                        {dynamicFoundations.map((found) => {
                          const label = locale === "en" ? found.en : found.ar;
                          return (
                            <li
                              key={label}
                              className={`option-item ${selectedFoundation === label ? "active" : ""}`}
                              onClick={() => {
                                setSelectedFoundation(label);
                                setIsFoundationOpen(false);
                              }}
                            >
                              {label}
