...
export default function ServiceFoundation({ setActiveTab }) {
  ...
  return (
    <div className="ServiceFoundation">
      <div className="mb-5">
                  ...
                  <div className="services-box">
                    ...
                    <div
                      onClick={() => {
                        const name =
                          locale === "en" ? item.type_en : item.type_ar;
                        setActiveTab("casesService", name); // نرسل الاسم كبارامتر ثاني
