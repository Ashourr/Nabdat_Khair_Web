...
export default function CasesServices({ selectedServiceName, setActiveTab }) {
  ...
  // let id = casesID
  return (
    <div className="cases-services">
      <div className="container">
        {/* <h>Cases ID {id}</h> */}
        <h3>
          {locale === "en" ? "Support for:" : "دعم لـ:"} {selectedServiceName}
        </h3>
        <div className="row">
